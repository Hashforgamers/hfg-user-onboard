...
class Config:
    ...
    COMMUNITY_PLATFORM_FEE_RATE = float(os.getenv("COMMUNITY_PLATFORM_FEE_RATE", "10") or 10)
    COMMUNITY_ADMIN_TOKEN = os.getenv("COMMUNITY_ADMIN_TOKEN", "")
    COMMUNITY_DISPUTE_CHAT_ENABLED = os.getenv("COMMUNITY_DISPUTE_CHAT_ENABLED", "false").lower() in ("true", "1", "t", "yes", "y")
    COMMUNITY_DISPUTE_ADMIN_USER_IDS = os.getenv("COMMUNITY_DISPUTE_ADMIN_USER_IDS", "")
    COMMUNITY_PAYMENT_CRON_TOKEN = os.getenv("COMMUNITY_PAYMENT_CRON_TOKEN", "")
    CLOUDINARY_CLOUD_NAME = os.getenv("CLOUDINARY_CLOUD_NAME", "")
    CLOUDINARY_API_KEY = os.getenv("CLOUDINARY_API_KEY", "")
    CLOUDINARY_API_SECRET = os.getenv("CLOUDINARY_API_SECRET", "")
    COMMUNITY_EVIDENCE_MAX_BYTES = int(os.getenv("COMMUNITY_EVIDENCE_MAX_BYTES", str(10 * 1024 * 1024)) or 10 * 1024 * 1024)
    COMMUNITY_EVIDENCE_RETENTION_DAYS = int(os.getenv("COMMUNITY_EVIDENCE_RETENTION_DAYS", "7") or 7)
    COMMUNITY_PAYMENT_ATTEMPT_TTL_MINUTES = int(os.getenv("COMMUNITY_PAYMENT_ATTEMPT_TTL_MINUTES", "30") or 30)
    COMMUNITY_PAYMENT_RECONCILIATION_MAX_ATTEMPTS = int(os.getenv("COMMUNITY_PAYMENT_RECONCILIATION_MAX_ATTEMPTS", "12") or 12)
    RAZORPAY_AUTO_CAPTURE_AUTHORIZED = os.getenv("RAZORPAY_AUTO_CAPTURE_AUTHORIZED", "false").lower() in ("true", "1", "t", "yes", "y")
